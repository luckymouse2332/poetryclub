...
import { PoemListCard, FeaturedPoems, Pagination, LoadingSpinner, PoemCardSkeleton } from "$lib/components";
...
<div class="container mx-auto px-4 py-8 max-w-7xl">
	...
	<header class="text-center mb-12">
		<h1 class="text-4xl font-bold font-kai poetry-text-primary mb-4">推荐诗作</h1>
		<p class="text-lg poetry-text-secondary">发现经典诗词之美，感受千年文化传承</p>
	</header>
