...
export function OwnPoemCard({ poem, suspended = false }: OwnPoemCardProps) {
  ...
  return (
    <article className="grid gap-4 border-b border-border-subtle py-5 first:border-t xl:grid-cols-[minmax(12rem,1.5fr)_8rem_9rem_11rem_minmax(13rem,auto)] xl:items-center xl:gap-5">
      ...
      <p className="text-label text-subtle"><span className="xl:hidden">更新于 </span>{formatPoemDate(poem.updatedAt)}</p>
